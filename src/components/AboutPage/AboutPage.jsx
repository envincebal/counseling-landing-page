  ...
  return (
    <div className="about-container">
      <div className="about-header">
        ...
        <h5>Jessica Wong, LCSW (Licensed Clinical Social Worker)</h5>
        <h5>EMDR Therapist (Eye Movement Desensitization and Re-Processing)</h5>
        <h5>Flash Technique Therapist</h5>
      </div>
      <p>
      ...
      <br />
      <h3>I am dedicated to helping people break through their strongholds.</h3>
      <br />
      <p>
      ...
      <div className="education-experience-div">
        <div className="education-div">
          <h3>Education</h3>
          <h4 className="education-experience-subtitle">Degrees</h4>
          <ul>
            <li>Master of Social Work: Hawaii Pacific University</li>
            <li>Bachelor’s of Arts: University of Oregon</li>
          </ul>
          <h4 className="education-experience-subtitle">Licensure</h4>
          <ul>
            <li>LCSW-4450: Licensed Clinical Social Worker</li>
          </ul>
          <h4 className="education-experience-subtitle">Certifications</h4>
          <ul>
          ...
          <h4 className="education-experience-subtitle">Other</h4>
          <ul>
        ...
        <div className="experience-div">
          <h3>Experience</h3>
          <h4 className="education-experience-subtitle">Professional Experience</h4>
          <ul>
